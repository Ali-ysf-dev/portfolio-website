...
const LightRays = ({
    ...
    useEffect(() => {
        ...
        // On mobile, IntersectionObserver can be unreliable, so set visible immediately
...
void main() {
  ...
  gl_FragColor  = color;
            ...
            const updatePlacement = () => {
                ...
                // Ensure valid dimensions (mobile sometimes needs retry)
                if (wCSS === 0 || hCSS === 0) {
            ...
            // Initial placement with retry for mobile
            updatePlacement();
            setTimeout(updatePlacement, 100);
